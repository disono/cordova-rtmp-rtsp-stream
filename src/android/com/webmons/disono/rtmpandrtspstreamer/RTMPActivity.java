...
public class RTMPActivity extends CordovaActivity implements ConnectCheckerRtmp {
  ...
  private void _startStreaming() {
    ...
    java.util.List<android.hardware.Camera.Size> _resolutions = rtmpCameral.getResolutionsBack();
    ...
    if (rtmpCameral.prepareAudio() && rtmpCameral.prepareVideo(_w, _h, 24, _w * _h, false, 0)) {
